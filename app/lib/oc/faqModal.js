    ...
    $scope.openFAQ = function (size) {
        ...
        function faqmodalopen() {
            return [
                ...
                '<ol>',
                '<li><span>Is there a bookstore at any of the UMUC sites where I can purchase UMUC Gear?</span><br />',
                'The UMUC GEAR store is only available online through this website and once a year at UMUC commencement ceremonies held at the Xfinity Center in Adelphi, Maryland.',
                '</li>',
                '<li><span>Where can I purchase a frame for my diploma or a UMUC class ring?</span><br />',
                'Diploma frames as well as UMUC class rings are available for purchase through the Balfour website:',
                '<a target="_blank" href="http://www.balfour.com/maryland/adelphi/university-of-maryland-university-college/">www.balfour.com</a>',
                '</li>',
                ...
                '</li>',
                '<li><span>I am shipping to the U.S. How long will it take to receive a shipment?</span><br />',
                ...
                'Overseas shipments take 4-6 weeks for delivery, depending on where your order will be shipped.',
                '</li>',
                '<li><span>How are packages shipped?</span><br />',
                'All packages are shipped UPS Ground Service, except for those with APO and FPO addresses, which are shipped via the United States Postal Service.',
                '</li>',
                '</ol>',
                ...
                '<h4 style="line-height: 1.3;">Shipping Address for returning Defective and/or Damaged Merchandise</h4>',
                '<address>',
                'Proforma Fulfillment Center<br />',
                'Attn: UMUC Gear<br />',
                '4597 Van Epps Road<br />',
                'Brooklyn Heights, OH 44131<br />',
                '<a href="tel:888-798-3865">888-798-3865</a>',
                '</address>',
                '</div>'
            ].join('');
        }
